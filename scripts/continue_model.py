def main():
    ...
    checkpoint_path = "./lora_roberta_finetuned/checkpoint_epoch_40_acc_0.8843"  # Replace with your checkpoint path
    ...
    # Modify the training loop to start from the checkpoint epoch
    for epoch in range(0, 1):
        ...
        # ----- Training Loop -----
        for epoch in range(start_epoch,num_train_epochs + start_epoch):
            model.train()
            running_loss = 0.0
            ...
            checkpoint_dir = os.path.join("./lora_roberta_finetuned", f"checkpoint_epoch_{epoch+1}_acc_{val_accuracy:.4f}")
        ...
        output_dir = "./lora_roberta_finetuned_preprocess"
