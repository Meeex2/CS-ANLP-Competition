...
#SBATCH --mem=32G
#SBATCH --output=nlp_kaggle_roberta_single.out       # Standard output (with job ID)
#SBATCH --error=nlp_kaggle_roberta_single.err        # Standard error (with job ID)
...
accelerate launch --mixed_precision "fp16" --num_processes 1 scripts/accelerate_model.py > nlp_kaggle_roberta_single${SLURM_JOB_ID}.log
