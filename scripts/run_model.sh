...
#SBATCH --time=00:40:00                  # Time limit (2 hours)
...
accelerate launch --multi_gpu --mixed_precision "fp16" --num_processes 2 --num_machines 1 --gpu_ids "0,1" --machine_rank 0 scripts/train_model.py > modern_bert_finetune.log